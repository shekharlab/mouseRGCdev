...
# Load atlas
rgc_atlas = readRDS("../Objects/rgc_atlas_190729.rds")

# load E13
rgcE13 = readRDS("../Objects/rgcE13_190825_2.rds")

# load E14
rgcE14 = readRDS("../Objects/rgcE14_190829_2.rds")

# load E16
rgcE16 = readRDS("../Objects/rgcE16_190729.rds")

# load P0
rgcP0 = readRDS("../Objects/rgcP0_190729.rds")

# load P5
rgcP5 = readRDS("../Objects/rgcP5_190729.rds")
...
save(list=c("class
_errors_vec", "class_errors"), file="Xgboost_class_errors.Rdata")
