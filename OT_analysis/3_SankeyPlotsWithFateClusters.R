...
e13_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_E13_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
e14_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_E14_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
e16_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_E16_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
p0_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_P0_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
p5_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_P5_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
p56_traj =  read.table("OT_uncorr_vargenes_eps005/tmaps/wot_eps005_P56_traj_fate_clusters.txt_trajectory.txt", header=TRUE, row.names = 1, sep="\t")
...
# set to fate clusters
rgcE13 = set.all.ident(rgcE13, id="fate_clusters")
rgcE14 = set.all.ident(rgcE14, id="fate_clusters")
rgcE16 = set.all.ident(rgcE16, id="fate_clusters")
rgcP0 = set.all.ident(rgcP0, id="fate_clusters")
rgcP5 = set.all.ident(rgcP5, id="fate_clusters")
